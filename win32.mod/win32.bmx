...
Extern "win32"
	...
	Function CallNextHookEx:LParam( hook:Byte Ptr, code:Int, wp:WParam, lp:LParam) = "LRESULT __stdcall CallNextHookEx(HHOOK, int, WPARAM, LPARAM)!"
End Extern

Function KeyboardProc:LParam(code:Int, wp:WParam, lp:LParam) "win32"
	If code <= 0 Then
