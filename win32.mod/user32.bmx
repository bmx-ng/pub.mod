...
Const HWND_TOP:LParam=0
Const HWND_BOTTOM:LParam=1
Const HWND_TOPMOST:LParam=-1
Const HWND_NOTOPMOST:LParam=-2
Const HWND_BROADCAST:LParam=$ffff
Const HWND_DESKTOP:LParam=0
Const HWND_MESSAGE:LParam=-3
...
Extern
	...
	Function bmx_win32_MENUITEMINFOW_SetdwItemData(handle:Byte Ptr, dwItemData:WParam)
...
Type MENUITEMINFOW
	...
	Method SetdwItemData(dwItemData:WParam)
...
Extern
	...
	Function bmx_win32_WNDCLASSW_SethbrBackground(handle:Byte Ptr, hbrBackground:Byte Ptr)
	Function bmx_win32_WNDCLASSW_SetBackgroundColor(handle:Byte Ptr, color:Int)
...
Type WNDCLASSW
	...
	Method SethbrBackground(hbrBackground:Byte Ptr)
		bmx_win32_WNDCLASSW_SethbrBackground(classPtr, hbrBackground)
	End Method

	Method SethbrBackground(color:Int)
		bmx_win32_WNDCLASSW_SetBackgroundColor(classPtr, color)
	End Method
...
Extern
	...
	Function bmx_win32_MENUINFO_SetdwMenuData(handle:Byte Ptr, dwMenuData:WParam)
End Extern
'Menu Info
Type MENUINFO
	Field infoPtr:Byte Ptr
	...
	Method SetdwMenuData(dwMenuData:WParam)
...
Function CreateWindowExA:Byte Ptr( dwExStyle,lpClassName:Byte Ptr,lpWindowName:Byte Ptr,dwStyle,x,y,nWidth,nHeight,hWndParent:Byte Ptr,hmenu:Byte Ptr,hInstance:Byte Ptr,lpParam:Byte Ptr )="HWND CreateWindowExA(DWORD,LPCSTR,LPCSTR,DWORD,int,int,int,int,HWND,HMENU,HINSTANCE,LPVOID)!"
...
Function DefWindowProcA:LParam( hWnd:Byte Ptr,MSG:UInt,wp:WParam,lp:LParam)="LRESULT DefWindowProcA(HWND,UINT,WPARAM,LPARAM)!"
Function DefWindowProcW:LParam( hWnd:Byte Ptr,MSG:UInt,wp:WParam,lp:LParam)="LRESULT DefWindowProcW(HWND,UINT,WPARAM,LPARAM)!"
Function DispatchMessageA:LParam( lpMsg:Byte Ptr )="LRESULT DispatchMessageA(const MSG*)!"
Function DispatchMessageW:LParam( lpMsg:Byte Ptr )="LRESULT DispatchMessageW(const MSG*)!"
...
Function PeekMessageA( lpMsg:Byte Ptr,hWnd:Byte Ptr,wMsgFilterMin,wMsgFilterMax,wRemoveMsg )="BOOL PeekMessageA(LPMSG,HWND,UINT,UINT,UINT)!"
Function PeekMessageW( lpMsg:Byte Ptr,hWnd:Byte Ptr,wMsgFilterMin,wMsgFilterMax,wRemoveMsg )="BOOL PeekMessageW(LPMSG,HWND,UINT,UINT,UINT)!"
...
Function SendMessageA:LParam( hWnd:Byte Ptr,MSG:UInt,wp:WParam,lp:LParam )="LRESULT SendMessageA(HWND ,UINT ,WPARAM ,LPARAM )!"
Function SendMessageW:LParam( hWnd:Byte Ptr,MSG:UInt,wp:WParam,lp:LParam )="LRESULT SendMessageW(HWND ,UINT ,WPARAM ,LPARAM )!"
Function PostThreadMessageA( idThread,Msg,wp:WParam,lp:LParam )="BOOL PostThreadMessageA(DWORD,UINT,WPARAM,LPARAM)!"
Function PostThreadMessageW( idThread,Msg,wp:WParam,lp:LParam )="BOOL PostThreadMessageW(DWORD,UINT,WPARAM,LPARAM)!"
Function GetDC:Byte Ptr( hWnd:Byte Ptr )="HDC GetDC(HWND)!"
Function PostQuitMessage( nExitCode )="void PostQuitMessage(int)!"
Function TranslateMessage( lpMsg:Byte Ptr )="BOOL TranslateMessage(const MSG*)!"
Function DestroyWindow:Int( hWnd:Byte Ptr )="BOOL DestroyWindow(HWND)!"
Function MsgWaitForMultipleObjects( nCount,pHandles:Byte Ptr,fWaitAll,dwMilliseconds,dwWakeMask )="DWORD MsgWaitForMultipleObjects(DWORD,const HANDLE*,BOOL,DWORD,DWORD)!"
Function MsgWaitForMultipleObjectsEx( nCount,pHandles:Byte Ptr,dwMilliseconds,dwWakeMask,dwFlags )="DWORD MsgWaitForMultipleObjectsEx(DWORD,const HANDLE*,DWORD,DWORD,DWORD)!"
Function ChangeDisplaySettingsA( lpDevMode:Byte Ptr,dwFlags )="LONG ChangeDisplaySettingsA(DEVMODEA*,DWORD)!"
Function ChangeDisplaySettingsW( lpDevMode:Byte Ptr,dwFlags )="LONG ChangeDisplaySettingsW(DEVMODEW*,DWORD)!"
Function LoadCursorA:Byte Ptr( hInstance:Byte Ptr,lpCursorName:Byte Ptr )="HCURSOR LoadCursorA(HINSTANCE,LPCSTR)!"
Function LoadCursorW:Byte Ptr( hInstance:Byte Ptr,lpCursorName:Short Ptr )="HCURSOR LoadCursorW(HINSTANCE,LPCWSTR)!"
Function ShowCursor( visible )="BBINT ShowCursor(BBINT )!"
Function SetCursor:Byte Ptr( hCursor:Byte Ptr )="HCURSOR SetCursor(HCURSOR )!"
Function LoadIconA:Byte Ptr( hInstance:Byte Ptr,lpIconName:Byte Ptr )="HICON LoadIconA(HINSTANCE,LPCSTR)!"
Function LoadIconW:Byte Ptr( hInstance:Byte Ptr,lpIconName:Short Ptr )="HICON LoadIconW(HINSTANCE,LPCWSTR)!"
Function LoadLibraryA:Byte Ptr( dll$z )="HMODULE LoadLibraryA(LPCSTR)!"
...
Function GetClientRect( hWnd:Byte Ptr,lpRect:Int Ptr )="BOOL GetClientRect(HWND,LPRECT)!"
Function GetWindowRect( hWnd:Byte Ptr,lpRect:Int Ptr )="BOOL GetWindowRect(HWND,LPRECT)!"
Function GetDesktopWindow:Byte Ptr()="HWND GetDesktopWindow()!"
Function AdjustWindowRect( rect:Int Ptr,style,menu )="BOOL AdjustWindowRect(LPRECT,DWORD,BOOL)!"
Function AdjustWindowRectEx( rect:Int Ptr,style,menu:Int,exstyle )="BOOL AdjustWindowRectEx(LPRECT,DWORD,BOOL,DWORD)!"
Function ClientToScreen( hWnd:Byte Ptr,point:Byte Ptr )="BOOL ClientToScreen(HWND,LPPOINT)!"
...
Function TrackPopupMenu(hmenu:Byte Ptr,uFlags:UInt,x,y,nReserved,hWnd:Byte Ptr,prcRect:Byte Ptr)="BOOL TrackPopupMenu(HMENU,UINT,int,int,int,HWND,const RECT*)!"
Function DestroyMenu(hmenu:Byte Ptr)="BBINT DestroyMenu(HMENU)!"
Function EnableMenuItem(hmenu:Byte Ptr,uIDEnableItem,uEnable)="BOOL EnableMenuItem(HMENU,UINT,UINT)!"
Function CheckMenuItem(hmenu:Byte Ptr,uIDCheckItem,uCheck)="DWORD CheckMenuItem(HMENU,UINT,UINT)!"

Function AppendMenuA(hmenu:Byte Ptr,uFlags:UInt,uIDNewItem:WParam,lpNewItem:Byte Ptr)="BOOL AppendMenuA(HMENU,UINT,UINT_PTR,LPCSTR)!"
Function AppendMenuW(hmenu:Byte Ptr,uFlags:UInt,uIDNewItem:WParam,lpNewItem:Byte Ptr)="BOOL AppendMenuW(HMENU,UINT,UINT_PTR,LPCWSTR)!"
Function SetMenuItemInfoA( hmenu:Byte Ptr,item,fByPosition,info:Byte Ptr )="BOOL SetMenuItemInfoA(HMENU,UINT,BOOL,LPCMENUITEMINFOA)!"
Function SetMenuItemInfoW( hmenu:Byte Ptr,item,fByPosition,info:Byte Ptr )="BOOL SetMenuItemInfoW(HMENU,UINT,BOOL,LPCMENUITEMINFOW)!"
Function GetMenuItemCount( hmenu:Byte Ptr )="BBINT GetMenuItemCount(HMENU)!"
Function SetWindowTextA( hWnd:Byte Ptr,text$z )="BOOL SetWindowTextA(HWND,LPCSTR)!"
Function SetWindowTextW( hWnd:Byte Ptr,text$w )="BOOL SetWindowTextW(HWND,LPCWSTR)!"
...
Function GetWindowLongA( hWnd:Byte Ptr,index )="LONG GetWindowLongA(HWND,int)!"
Function SetWindowLongA( hWnd:Byte Ptr,index,newlong )="LONG SetWindowLongA(HWND,int,LONG)!"
Function GetWindowLongW( hWnd:Byte Ptr,index )="LONG GetWindowLongW(HWND,int)!"
Function SetWindowLongW( hWnd:Byte Ptr,index,newlong )="LONG SetWindowLongW(HWND,int,LONG)!"
Function GetWindowLongPtrA:LParam( hWnd:Byte Ptr,index:Int )="LONG_PTR __stdcall GetWindowLongPtrA(HWND,int)!"
Function GetWindowLongPtrW:LParam( hWnd:Byte Ptr,index:Int )="LONG_PTR __stdcall GetWindowLongPtrW(HWND,int)!"
Function SetWindowLongPtrA:LParam( hWnd:Byte Ptr,index:Int,newlong:LParam)="LONG_PTR __stdcall SetWindowLongPtrA(HWND,int,LONG_PTR)!"
Function SetWindowLongPtrW:LParam( hWnd:Byte Ptr,index:Int,newlong:LParam)="LONG_PTR __stdcall SetWindowLongPtrW(HWND,int,LONG_PTR)!"
Function GetClassLongA( hWnd:Byte Ptr,index )="DWORD GetClassLongA(HWND,int)!"
Function SetClassLongA( hWnd:Byte Ptr,index,newlong )="DWORD SetClassLongA(HWND,int,LONG)!"
Function GetClassLongW( hWnd:Byte Ptr,index )="DWORD GetClassLongW(HWND,int)!"
Function SetClassLongW( hWnd:Byte Ptr,index,newlong )="DWORD SetClassLongW(HWND,int,LONG)!"
Function GetClassLongPtrA:WParam( hWnd:Byte Ptr,index:Int )="ULONG_PTR __stdcall GetClassLongPtrA(HWND,int)!"
Function GetClassLongPtrW:WParam( hWnd:Byte Ptr,index:Int )="ULONG_PTR __stdcall GetClassLongPtrW(HWND,int)!"
Function SetClassLongPtrA:WParam( hWnd:Byte Ptr,index:Int,newlong:LParam )="ULONG_PTR __stdcall SetClassLongPtrA(HWND,int,LONG_PTR)!"
Function SetClassLongPtrW:WParam( hWnd:Byte Ptr,index:Int,newlong:LParam )="ULONG_PTR __stdcall SetClassLongPtrW(HWND,int,LONG_PTR)!"
Function IsZoomed( hWnd:Byte Ptr )="BBINT IsZoomed(HWND )!"
Function CallWindowProcA:LParam( proc:Byte Ptr,hWnd:Byte Ptr,msg:UInt,wp:WParam,lp:LParam)="LRESULT CallWindowProcA(WNDPROC ,HWND ,UINT ,WPARAM ,LPARAM )!"
Function CallWindowProcW:LParam( proc:Byte Ptr,hWnd:Byte Ptr,msg:UInt,wp:WParam,lp:LParam )="LRESULT CallWindowProcW(WNDPROC ,HWND ,UINT ,WPARAM ,LPARAM )!"
Function OleInitialize(pvReserved:Byte Ptr)="HRESULT OleInitialize(LPVOID)!"
Function OleUninitialize()="void OleUninitialize()!"
Function InitCommonControlsEx(controlsex:Byte Ptr)="BOOL InitCommonControlsEx(const INITCOMMONCONTROLSEX*)!"
...
Function EnableScrollBar( hWnd:Byte Ptr,wSBflags,wArrows )="BOOL EnableScrollBar(HWND,UINT,UINT)!"
Function SetScrollInfo( hWnd:Byte Ptr,nBar,lpsi:Byte Ptr,redraw )="int SetScrollInfo(HWND,int,LPCSCROLLINFO,BOOL)!"
Function GetScrollInfo( hWnd:Byte Ptr,nBar,lpsi:Byte Ptr)="BOOL GetScrollInfo(HWND,int,LPSCROLLINFO)!"
Function InvalidateRect( hWnd:Byte Ptr,lpRect:Int Ptr,bErase )="BOOL InvalidateRect(HWND,const RECT*,BOOL)!"
Function ValidateRect( hWnd:Byte Ptr,lpRect:Int Ptr )="BOOL ValidateRect(HWND,const RECT*)!"
Function BeginPaint:Byte Ptr( hWnd:Byte Ptr,lpPaint:Byte Ptr )="HDC BeginPaint(HWND,LPPAINTSTRUCT)!"
Function FillRect( hdc:Byte Ptr,lpRect:Int Ptr,hbr:Byte Ptr )="int FillRect(HDC,const RECT*,HBRUSH)!"
Function EndPaint( hWnd:Byte Ptr,lpPaint:Byte Ptr )="BOOL EndPaint(HWND,const PAINTSTRUCT*)!"
...
Function SetActiveWindow:Byte Ptr( hWnd:Byte Ptr )="HWND SetActiveWindow(HWND)!"
...
Function GetWindowInfo( hWnd:Byte Ptr,winfo:Byte Ptr )="BOOL GetWindowInfo(HWND,PWINDOWINFO)!"
Function GetCursorPos_( lpPoint:Int Ptr)="BOOL GetCursorPos(LPPOINT)!"

Function EnumChildWindows( hWnd:Byte Ptr,lpfn:Byte Ptr,lp:LParam )="BOOL EnumChildWindows(HWND,WNDENUMPROC,LPARAM)!"
Function EnumWindows( lpfn:Byte Ptr,lp:LParam )="BOOL EnumWindows(WNDENUMPROC,LPARAM)!"

Function OpenClipboard(hWnd:Byte Ptr)="BBINT OpenClipboard(HWND )!"
Function CloseClipboard()="BBINT CloseClipboard()!"
Function SetClipboardData:Byte Ptr(uFormat:UInt,hMem:Byte Ptr)="HANDLE SetClipboardData(UINT,HANDLE)!"
Function GetClipboardData:Byte Ptr(uFormat:UInt)="HANDLE GetClipboardData(UINT)!"
Function EmptyClipboard()="BBINT EmptyClipboard()!"
Function IsClipboardFormatAvailable(format)="BOOL IsClipboardFormatAvailable(UINT)!"

Function DefDlgProcW:LParam(hDlg:Byte Ptr,Msg:UInt,wp:WParam,lp:LParam)="LRESULT DefDlgProcW(HWND,UINT,WPARAM,LPARAM)!"
...
Function DragAcceptFiles(hWnd:Byte Ptr,fAccept)="void DragAcceptFiles(HWND,BOOL)!"
Function DragQueryPoint(hDrop:Byte Ptr,lpPoint:Int Ptr)="BOOL DragQueryPoint(HDROP,POINT*)!"
Function DragQueryFileW(hDrop:Byte Ptr,iFile:UInt,lpszFile:Short Ptr,cch:UInt)="UINT DragQueryFileW(HDROP,UINT,LPWSTR,UINT)!"
